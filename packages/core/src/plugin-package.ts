...
const T3_ORCHESTRATION_ENTRYPOINTS = ["src/cli.ts", "src/daemon.ts", "src/worktree-reaper-cli.ts"] as const;
const T3_ORCHESTRATION_STATIC_INPUTS = ["package.json", "README.md", "scripts/install.ts", "scripts/install-reaper.ts", "scripts/host-gateway.ts"] as const;
