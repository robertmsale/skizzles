...
const T3_ORCHESTRATION_ENTRYPOINTS = ["src/cli.ts", "src/daemon.ts", "src/auto-guardian-cli.ts"] as const;
const T3_ORCHESTRATION_STATIC_INPUTS = ["package.json", "README.md", "scripts/install.ts", "scripts/install-guardian.ts", "scripts/host-gateway.ts"] as const;
