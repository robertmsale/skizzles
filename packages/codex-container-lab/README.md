...
3. From a Codex unified shell, run the selected launcher with `health`, then `lab create --name experiment`. `CODEX_THREAD_ID` supplies the exact owner automatically.
